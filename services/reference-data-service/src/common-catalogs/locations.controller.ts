...
export class LocationsController {
  ...
  @Get()
  findAll(@Query() query: ListLocationsDto) {
  ...
  @Roles('ADMIN')
  @Post()
  create(@Body() dto: CreateLocationDto, @CurrentUser() actor: JwtPayload) {
    return this.service.create(dto, actor.code);
  }

  @Roles('ADMIN')
  @Patch(':id')
  update(@Param('id') id: string, @Body() dto: UpdateLocationDto, @CurrentUser() actor: JwtPayload) {
